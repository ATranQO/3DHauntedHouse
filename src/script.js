...
const floorAplhaTexture = textureLoader.load("./floor/alpha.webp");
...
//SRGBColorSpace vždycky jde s colorTexture!!
...
const floor = new THREE.Mesh(
  ...
  new THREE.MeshStandardMaterial({
    //alphaMap je vždycky s tranparent
...
//výška je 2,5, ale box je pod podlahou, abychoom docílili toho, že bude přesně
//nad podlahou, musím výšku vydělit 2
//rozdil mezi = a += je ten ze = je od aktualni pozice 0, zatimco += je od aktualni pozice
walls.position.y += 1.25;
//přidání do domu groupy
house.add(walls);
...
for (let i = 0; i < 30; i++) {
  ...
  //pokud přidáme -0.5, dostaneme random číslo i v negativním stavu
...
//Nedokážeme proměnou vytáhnout z loopu, proto tady ta taktika
